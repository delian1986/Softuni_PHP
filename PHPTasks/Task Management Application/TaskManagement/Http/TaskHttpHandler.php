...
class TaskHttpHandler extends HttpHandlerAbstract
{
    ...
    public function edit(TaskServiceInterface $taskService, CategoryServiceInterface $categoryService, UserServiceInterface $userService, array $formData = [], array $getData = [])
    {
    ...
    public function handleEditProcess(TaskServiceInterface $taskService, CategoryServiceInterface $categoryService, UserServiceInterface $userService, array $formData = [], array $getData = [])
    {
        $author = $userService->getCurrentUser();
        $category = $categoryService->view($formData['category_id']);
        /** @var TaskDTO $task $task */
    ...
    public function add(TaskServiceInterface $taskService, CategoryServiceInterface $categoryService, UserServiceInterface $userService, array $formData = [])
    {
    ...
    public function handleInsertProcess(TaskServiceInterface $taskService, CategoryServiceInterface $categoryService, UserServiceInterface $userService, $formData)
    {
        $author = $userService->getCurrentUser();
        $category = $categoryService->view($formData['category_id']);
        /** @var TaskDTO $task $task */
